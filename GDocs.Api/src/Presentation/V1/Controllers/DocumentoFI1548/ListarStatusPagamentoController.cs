...
namespace ICE.GDocs.Api.V1.Controllers.DocumentoFI1548
{
    ...
    public class ListarStatusPagamentoController : ControllerBase
    {
        private readonly IDocumentoFI1548AppService _documentoFI1548AppService;

        public ListarStatusPagamentoController(
        ...
        [HttpPost("")]
        public async Task<ActionResult<IEnumerable<DocumentoFI1548StatusModel>>> Post(
            CancellationToken cancellationToken = default
        )
        {
            var response = await _documentoFI1548AppService.ListarStatusPagamento(cancellationToken);
